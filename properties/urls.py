...
urlpatterns = [
    ...
    path('my-properties/bulk-actions/', views.bulk_property_actions, name='bulk_property_actions'),
    ...
    path('duplicate/<int:pk>/', views.duplicate_property_view, name='duplicate_property'),
